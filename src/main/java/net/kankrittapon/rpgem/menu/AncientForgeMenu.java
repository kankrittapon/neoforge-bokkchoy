...
public class AncientForgeMenu extends AbstractContainerMenu {
    ...
    public AncientForgeMenu(int containerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        addSlotListener(new net.minecraft.world.inventory.ContainerListener() {
            @Override
        ...
        if (entity instanceof net.kankrittapon.rpgem.block.entity.AncientForgeBlockEntity be) {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.ANCIENT_FORGE_TABLE.get());
    }
